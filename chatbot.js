var sendForm = document.querySelector('#chatform'),
    ...
    previousInput,
    isReaction = false,
    unkwnCommReaction = "Sorry, I don't understand.",
...
var possibleInput = {
  "about" : function(){
    responseText("I'm a Chatbot.");
    responseText("A chatbot is a computer program or an artificial intelligence which conducts a conversation via auditory or textual methods.");
    commandReset(0);
    return
  },
  "contact" : function(){
    responseText("Facebook: <a href='https://www.facebook.com/help/'>@contact</a>");
    commandReset(1);
    return
  },
  "commands" : function(){
    responseText("contact, Google");
    commandReset(2);
    return
  },
  "google" : function(){
